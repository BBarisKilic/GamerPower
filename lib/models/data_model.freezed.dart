...
mixin _$DataModel {
  ...
  String get open_giveaway => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      gamerpower_url: gamerpower_url == freezed
          ...
          : gamerpower_url // ignore: cast_nullable_to_non_nullable
              as String,
      open_giveaway: open_giveaway == freezed
          ? _value.open_giveaway
          : open_giveaway // ignore: cast_nullable_to_non_nullable
              as String,
    ));
  }
}
...
class _$_DataModel implements _DataModel {
  ...
  @override
  String toString() {
    return 'DataModel(id: $id, title: $title, worth: $worth, thumbnail: $thumbnail, image: $image, description: $description, instructions: $instructions, open_giveaway_url: $open_giveaway_url, published_date: $published_date, type: $type, platforms: $platforms, end_date: $end_date, users: $users, status: $status, gamerpower_url: $gamerpower_url, open_giveaway: $open_giveaway)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.open_giveaway, open_giveaway));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(open_giveaway));
...
abstract class _DataModel implements DataModel {
  const factory _DataModel(
      ...
      required String status,
      required String gamerpower_url,
      required String open_giveaway}) = _$_DataModel;
